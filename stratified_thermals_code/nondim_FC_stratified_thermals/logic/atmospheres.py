...
class Polytrope(IdealGasAtmosphere):
    ...
    def _setup_atmosphere(self):
        ...
        T0 = (1 + self.params['T_ad_z']*(self.de_domain.z - self.params['Lz']))
        self.atmo_fields['T0'] = set_field(self.atmo_fields['T0'], T0, scales=1)
        self.atmo_fields['T0_z'] = set_field(self.atmo_fields['T0_z'], self.params['T_ad_z'], scales=1)
