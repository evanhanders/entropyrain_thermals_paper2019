...
\textbf{In this work we study vortex rings generated by discrete cold thermals, but time-stationary cooling produces similar vortex ring structures \citep[as in e.g.,][]{rast1998}.
...
\textbf{Thi sis the appropriate regime of deep solar convection.}
...
Panel 5 of Fig.~\ref{fig:thermal_sun_comparison} displays $f_{\text{th}}$ vs.~depth.
